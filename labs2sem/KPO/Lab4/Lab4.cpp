...
void prog_day(int day, int daysInMonth[12]);
...
int main()
{
    ...
    while (true)
    {
        ...
        cout << "\n--------------------------------\n";
        cout << "\nВведенная дата - " << day << " "; month_name(month); cout << years << "\n\n";
        ...
        cout << "\nВведенная дата - " << day << " "; month_name(month); cout << "\n";
...
void prog_day(int day, int daysInMonth[12]) {
    ...
    cout << "\nДень программиста - " << day << " "; month_name(month); cout << "\n";
}