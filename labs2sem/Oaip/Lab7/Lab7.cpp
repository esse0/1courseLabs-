//returnN – функция возвращения истинного значения, 
//если список пуст и возвращение ложного в противном случае.
...
int main(void)
{
	...
	while (true)
	{
		...
		case 6:
			...
			break;
		case 7:
			if (returnN(&head)) cout << "Список пуст" << endl;
